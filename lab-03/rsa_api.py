...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        # Gắn các nút với hàm gọi API
        self.ui.generate_keys.clicked.connect(self.call_api_gen_keys)
        self.ui.encryptBtt.clicked.connect(self.call_api_encrypt)
        self.ui.decryptBtt.clicked.connect(self.call_api_decrypt)
        self.ui.signatureBtt.clicked.connect(self.call_api_sign)
        self.ui.verifyBtt.clicked.connect(self.call_api_verify)
